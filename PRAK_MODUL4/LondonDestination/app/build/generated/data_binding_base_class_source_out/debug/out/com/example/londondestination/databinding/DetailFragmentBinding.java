...
public final class DetailFragmentBinding implements ViewBinding {
  ...
  private DetailFragmentBinding(@NonNull ScrollView rootView, @NonNull TextView detailDescription,
      @NonNull ImageView detailImage, @NonNull ScrollView detailScrollView,
  ...
  public static DetailFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ScrollView detailScrollView = (ScrollView) rootView;
      ...
      return new DetailFragmentBinding((ScrollView) rootView, detailDescription, detailImage,
          detailScrollView, detailTitle);
    }
